...
export const projects: Project[] = [
  ...
  {
    title: "Sabi Agent",
    subtitle: "Rust Coding-Agent Harness",
    description:
      "A Rust implementation of a coding-agent harness with an OpenAI-compatible agent loop, file tools, session persistence, approval-gated mutations, skill discovery, and an early Tauri desktop shell over the same reusable engine.",
    tags: ["Rust", "Tauri", "TypeScript", "OpenAI-Compatible APIs", "Agent Tools", "JSONL Sessions"],
    compactTags: ["Rust", "Tauri", "AI Agent"],
    highlights: [
